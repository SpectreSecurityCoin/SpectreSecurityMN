...
The script [extract-osx-sdk.sh](https://github.com/spectresecurity-project/spectresecurity/blob/master/contrib/macdeploy/extract-osx-sdk.sh) automates this. First ensure
...
spectresecurity/contrib/macdeploy/extract-osx-sdk.sh
...
Troubleshooting
---------------
See [README_osx.md](https://github.com/spectresecurity-project/spectresecurity/blob/master/doc/README_osx.md) for troubleshooting tips.