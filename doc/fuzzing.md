Fuzz-testing SPECTRESECURITY Core
==========================
...
To build SPECTRESECURITY Core using AFL instrumentation (this assumes that the
...
with certain assembly code from SPECTRESECURITY Core's code. See [developer notes on sanitizers](https://github.com/Spectresecurity/spectresecurity/blob/master/doc/developer-notes.md#sanitizers)
