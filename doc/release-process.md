...
* Update translations (ping Fuzzbawls on Discord) see [translation_process.md](https://github.com/${projectName^}/${projectName}/blob/master/doc/translation_process.md#synchronising-translations).
...
- Announce the release:
  ...
  - Create a [new GitHub release](https://github.com/${projectName^}/${projectName}/releases/new) with a link to the archived release notes.
