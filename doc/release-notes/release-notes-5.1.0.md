SPECTRESECURITY Core version v5.1.0 is now available from:  <https://github.com/spectresecurity-project/spectresecurity/releases>
...
- #2170 Better spectresecurity.conf Masternode data error notification (furszy)
