Contributing to SPECTRESECURITY Core
============================

The SPECTRESECURITY Core project operates an open contributor model where anyone is
...
[Translation Process](https://github.com/spectresecurity-project/spectresecurity/blob/master/doc/translation_process.md)
...
The following applies to code changes to the SPECTRESECURITY Core project, and is not to be
confused with overall SPECTRESECURITY Network Protocol consensus changes.

Whether a pull request is merged into SPECTRESECURITY Core rests with the project merge
...
Patches that change SPECTRESECURITY consensus rules are considerably more involved than
...
Where a patchset proposes to change the SPECTRESECURITY consensus, it must have been
...
The project leader is the release manager for each SPECTRESECURITY Core release.
