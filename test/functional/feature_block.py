...
# Copyright (c) 2020-2022 The SPECTRESECURITY Core developers
...
class FullBlockTest(SpectresecurityTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure spectresecurityd isn't accepting b26
        ...
        # Extend the b28 chain to make sure spectresecurityd isn't accepting b28
        ...
        # SPECTRESECURITY: timestamp checks disabled for regtest
        ...
        #    Low-S and High-S values (whereas the spectresecurity code has custom code which does so);
