...
from test_framework.test_framework import SpectresecurityTier2TestFramework
...
class MasternodeGovernanceBasicTest(SpectresecurityTier2TestFramework):
    ...
    def run_test(self):
        ...
        firstProposalLink = "https://forum.spectresecurity.org/t/test-proposal"
