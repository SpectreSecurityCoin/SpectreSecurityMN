...
COIN = 100000000  # 1 SSMN in satoshis
...
# Objects that map to spectresecurityd objects, which can be serialized/deserialized
class CAddress:
...
class msg_headers:
    ...
    def deserialize(self, f):
        # comment in spectresecurityd indicates these should be deserialized as blocks
