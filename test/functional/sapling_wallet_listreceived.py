...
class ListReceivedTest (SpectresecurityTestFramework):
    ...
    def run_test(self):
        ...
        self.nodes[0].sendtoaddress(taddr, 6.0) # node_1 in taddr with 6 SSMN.
        ...
        # Send 1 SSMN to shield addr1
        txid = self.nodes[1].shieldsendmany(taddr, [ # node_1 with 6 SSMN sending them all (fee is 0.1 SSMN)
        ...
        # Confirm transaction (2 SSMN from taddr to shield_addr1)
        ...
        txid = self.nodes[1].shieldsendmany(shield_addr1, # shield_addr1 has 2 SSMN, send 0.6 SSMN + 0.05 SSMN fee
