...
class DIP3Test(SpectresecurityTestFramework):
    ...
    def run_test(self):
        ...
        # Note: dmn2 sends (2 * 0.3 SSMN) to the operator, and (2 * 2.7 SSMN) to the owner
        ...
        assert_raises_rpc_error(-5, "invalid SPECTRESECURITY address InvalidPayee",
        ...
        assert_raises_rpc_error(-5, "invalid SPECTRESECURITY address InvalidPayee", controller.protx_update_registrar,
