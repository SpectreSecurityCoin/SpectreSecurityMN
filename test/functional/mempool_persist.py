...
By default, spectresecurityd will dump mempool on shutdown and
...
class MempoolPersistTest(SpectresecurityTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent spectresecurityd from writing mempool.dat to disk. Verify that `savemempool` fails")
