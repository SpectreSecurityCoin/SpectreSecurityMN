...
class TxnMallTest(SpectresecurityTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 6,250 SSMN:
        ...
        # First: use raw transaction API to send 1240 * 5 SSMN to node1_address,
        # but don't broadcast:
