...
EXPECTED_CIRCULAR_DEPENDENCIES=(
    ...
    "qt/spectresecurity/spectresecuritygui -> qt/spectresecurity/qtutils -> qt/spectresecurity/spectresecuritygui"
    "qt/spectresecurity/qtutils -> qt/spectresecurity/snackbar -> qt/spectresecurity/qtutils"
    "sapling/saplingscriptpubkeyman -> wallet/wallet -> sapling/saplingscriptpubkeyman"
    "spork -> sporkdb -> spork"
    "spork -> validation -> spork"
    "txmempool -> validation -> txmempool"
    "validation -> validationinterface -> validation"
    "validation -> zssmn/zssmnmodule -> validation"
