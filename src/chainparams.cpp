...
public:
    CMainParams()
    {
		...
		*/
        ...
        vSeeds.emplace_back("${projectReplacementfuzzy}", "${projectSeed1}", true);     // Primary DNS Seeder from Fuzzbawls
        vSeeds.emplace_back("${projectReplacementfuzzy}", "${projectSeed1}", true);    // Secondary DNS Seeder from Fuzzbawls
...
public:
    CTestNetParams()
    {
        ...
        vSeeds.emplace_back("${projectReplacementfuzzy}", "spectresecurity-testnet.seed.${projectReplacementfuzzy}", true);
        vSeeds.emplace_back("${projectReplacementfuzzy}", "spectresecurity-testnet.seed2.${projectReplacementfuzzy}", true);
