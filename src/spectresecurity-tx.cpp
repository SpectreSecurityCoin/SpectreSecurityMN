...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = _("Spectresecurity Core spectresecurity-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  spectresecurity-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded spectresecurity transaction") + "\n" +
                               "  spectresecurity-tx [options] -create [commands]   " + _("Create hex-encoded spectresecurity transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded spectresecurity transaction
