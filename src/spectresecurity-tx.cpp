...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help")) {
        ...
        std::string strUsage = PACKAGE_NAME " spectresecurity-tx utility version " + FormatFullVersion() + "\n\n" +
                               "Usage:  spectresecurity-tx [options] <hex-tx> [commands]  Update hex-encoded spectresecurity transaction\n" +
                               "or:     spectresecurity-tx [options] -create [commands]   Create hex-encoded spectresecurity transaction\n" +
                               "\n";
