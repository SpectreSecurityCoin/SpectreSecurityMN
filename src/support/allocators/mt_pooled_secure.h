...
#ifndef SPECTRESECURITY_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
#define SPECTRESECURITY_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
...
#endif // SPECTRESECURITY_SUPPORT_ALLOCATORS_MT_POOLED_SECURE_H
