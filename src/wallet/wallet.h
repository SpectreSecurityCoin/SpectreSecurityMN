...
#ifndef SPECTRESECURITY_WALLET_H
#define SPECTRESECURITY_WALLET_H
...
enum WalletFeature {
    ...
    FEATURE_PRE_SPECTRESECURITY = 61000, // inherited version..
...
public:
     ...
     * SPECTRESECURITY: group coins by pair <CTxDestination, Optional<CTxDestination>>. The optional destination
    ...
    /// Get 10000 SSMN output and keys which can be used for the Masternode
    ...
    bool CreateCoinstakeOuts(const CSsmnStake& stakeInput, std::vector<CTxOut>& vout, CAmount nTotal) const;
...
#endif // SPECTRESECURITY_WALLET_H
