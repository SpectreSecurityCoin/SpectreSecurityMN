...
extern const char * const SPECTRESECURITY_CONF_FILENAME;
extern const char * const SPECTRESECURITY_PID_FILENAME;
extern const char * const SPECTRESECURITY_MASTERNODE_CONF_FILENAME;
...
{
    std::string s = strprintf("spectresecurity-%s", name);
