...
const struct NUInfo NetworkUpgradeInfo[Consensus::MAX_NETWORK_UPGRADES] = {
        {
                /*.strName =*/ "Base",
                /*.strInfo =*/ "SPECTRESECURITY network",
        },
        {
                /*.strName =*/ "PoS",
        ...
        {
                /*.strName =*/ "SPECTRESECURITY_v3.4",
                /*.strInfo =*/ "New 256-bit stake modifier - start block v6",
        },
        {
                /*.strName =*/ "SPECTRESECURITY_v4.0",
        ...
        {
                /*.strName =*/ "SPECTRESECURITY_v5.2",
                /*.strInfo =*/ "New cold-staking rules",
        },
        {
                /*.strName =*/ "SPECTRESECURITY_v5.3",
                /*.strInfo =*/ "New staking rules",
        },
        {
                /*.strName =*/ "SPECTRESECURITY_v5.5",
                /*.strInfo =*/ "New rewards structure",
        },
        {
                /*.strName =*/ "SPECTRESECURITY_v5.6",
