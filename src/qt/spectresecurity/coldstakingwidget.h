...
#include "qt/spectresecurity/txviewholder.h"
#include "qt/spectresecurity/tooltipmenu.h"
#include "qt/spectresecurity/sendmultirow.h"
#include "qt/spectresecurity/coldstakingmodel.h"
...
public:
    explicit ColdStakingWidget(SPECTRESECURITYGUI* parent);
    ~ColdStakingWidget();
