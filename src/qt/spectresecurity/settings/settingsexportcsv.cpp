...
#include "qt/spectresecurity/settings/forms/ui_settingsexportcsv.h"
#include <QFile>
...
SettingsExportCSV::SettingsExportCSV(SPECTRESECURITYGUI* _window, QWidget *parent) :
...
void SettingsExportCSV::selectFileOutput(const bool& isTxExport)
{
    QString filename = GUIUtil::getSaveFileName(this,
                                        ...
                                        isTxExport ? tr("SPECTRESECURITY_tx_csv_export(*.csv)") : tr("SPECTRESECURITY_addresses_csv_export(*.csv)"),
                                        nullptr);
