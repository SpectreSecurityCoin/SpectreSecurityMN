...
#include "qt/spectresecurity/settings/forms/ui_settingsbackupwallet.h"
...
SettingsBackupWallet::SettingsBackupWallet(SPECTRESECURITYGUI* _window, QWidget *parent) :
