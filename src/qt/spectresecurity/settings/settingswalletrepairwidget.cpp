...
#include "qt/spectresecurity/settings/forms/ui_settingswalletrepairwidget.h"
#include "qt/spectresecurity/qtutils.h"

SettingsWalletRepairWidget::SettingsWalletRepairWidget(SPECTRESECURITYGUI* _window, QWidget *parent) :
...
void SettingsWalletRepairWidget::buildParameterlist(QString arg)
{
    ...
    // Send command-line arguments to SPECTRESECURITYGUI::handleRestart()
