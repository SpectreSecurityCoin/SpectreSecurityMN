...
#include "qt/spectresecurity/settings/forms/ui_settingswalletoptionswidget.h"
#include <QListView>
#include "optionsmodel.h"
#include "clientmodel.h"
#include "qt/spectresecurity/qtutils.h"

SettingsWalletOptionsWidget::SettingsWalletOptionsWidget(SPECTRESECURITYGUI* _window, QWidget *parent) :
