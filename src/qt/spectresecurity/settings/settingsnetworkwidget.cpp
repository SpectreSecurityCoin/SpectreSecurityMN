// Copyright (c) 2019 The SPECTRESECURITY Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#include "qt/spectresecurity/settings/settingsnetworkwidget.h"
#include "qt/spectresecurity/settings/forms/ui_settingsnetworkwidget.h"
#include "optionsmodel.h"
#include "qt/spectresecurity/qtutils.h"

SettingsNetworkWidget::SettingsNetworkWidget(SPECTRESECURITYGUI* _window, QWidget *parent) :
