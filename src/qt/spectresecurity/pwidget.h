...
#include <QWidget>
#include <QString>
#include "qt/spectresecurity/prunnable.h"
...
class PWidget : public QWidget, public Runnable, public Translator
{
    Q_OBJECT
public:
    explicit PWidget(SPECTRESECURITYGUI* _window = nullptr, QWidget *parent = nullptr);
    explicit PWidget(PWidget *parent = nullptr);

    void setClientModel(ClientModel* model);
    void setWalletModel(WalletModel* model);

    SPECTRESECURITYGUI* getWindow() { return this->window; }
