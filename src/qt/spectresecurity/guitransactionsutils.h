...
#ifndef FURSZY_SPECTRESECURITY_GUITRANSACTIONSUTILS_H
#define FURSZY_SPECTRESECURITY_GUITRANSACTIONSUTILS_H
...
#endif //FURSZY_SPECTRESECURITY_GUITRANSACTIONSUTILS_H
