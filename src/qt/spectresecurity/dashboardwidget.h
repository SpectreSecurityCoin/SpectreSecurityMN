...
#include "config/spectresecurity-config.h" /* for USE_QTCHARTS */
#endif
...
public:
    ...
    qint64 totalSsmn = 0;
    qint64 totalZssmn = 0;
    QList<qreal> valuesSsmn;
    QList<qreal> valueszSsmn;
    QStringList xLabels;
};
...
public:
    explicit DashboardWidget(SPECTRESECURITYGUI* _window);
    ~DashboardWidget();
