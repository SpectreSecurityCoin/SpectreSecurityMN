...
#include "qt/spectresecurity/createproposaldialog.h"
#include "qt/spectresecurity/forms/ui_createproposaldialog.h"

#include "qt/spectresecurity/contactsdropdown.h"
...
CreateProposalDialog::CreateProposalDialog(SPECTRESECURITYGUI* parent, GovernanceModel* _govModel, WalletModel* _walletModel) :
    QDialog(parent),
...
void CreateProposalDialog::setupPageOne()
{
    ...
    setEditBoxStyle(ui->labelURL, ui->lineEditURL, "e.g https://forum.spectresecurity/proposals/best_proposal_ever");
...
void CreateProposalDialog::setupPageTwo()
{
    ...
    setEditBoxStyle(ui->labelAmount, ui->lineEditAmount, "e.g 500 SSMN");
...
void CreateProposalDialog::onAddrListClicked()
{
    ...
    if (!menuContacts) {
        ...
        menuContacts = new ContactsDropdown(
                width,
                height,
                dynamic_cast<SPECTRESECURITYGUI*>(parent()),
                this
        );
