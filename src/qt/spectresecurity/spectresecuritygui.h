...
#ifndef SPECTRESECURITY_CORE_NEW_GUI_SPECTRESECURITYGUI_H
#define SPECTRESECURITY_CORE_NEW_GUI_SPECTRESECURITYGUI_H
...
/**
  SPECTRESECURITY GUI main class. This class represents the main window of the SPECTRESECURITY UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class SPECTRESECURITYGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit SPECTRESECURITYGUI(const NetworkStyle* networkStyle, QWidget* parent = 0);
    ~SPECTRESECURITYGUI();
...
#endif //SPECTRESECURITY_CORE_NEW_GUI_SPECTRESECURITYGUI_H
