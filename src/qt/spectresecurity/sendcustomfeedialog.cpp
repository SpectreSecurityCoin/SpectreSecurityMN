...
SendCustomFeeDialog::SendCustomFeeDialog(SPECTRESECURITYGUI* parent, WalletModel* model) :
    ...
    walletModel(model)
{
    ...
    if (parent)
        connect(parent, &SPECTRESECURITYGUI::themeChanged, this, &SendCustomFeeDialog::onChangeTheme);
