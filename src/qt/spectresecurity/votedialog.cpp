...
#include "qt/spectresecurity/forms/ui_votedialog.h"

#include "qt/spectresecurity/mnmodel.h"
#include "qt/spectresecurity/mnselectiondialog.h"
...
{
    SPECTRESECURITYGUI* window = dynamic_cast<SPECTRESECURITYGUI*>(parent());
