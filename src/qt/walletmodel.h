...
#ifndef SPECTRESECURITY_QT_WALLETMODEL_H
#define SPECTRESECURITY_QT_WALLETMODEL_H
...
/** Interface to SPECTRESECURITY wallet from Qt view code. */
...
#endif // SPECTRESECURITY_QT_WALLETMODEL_H
