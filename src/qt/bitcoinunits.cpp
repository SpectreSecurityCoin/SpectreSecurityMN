...
QList<BitcoinUnits::Unit> BitcoinUnits::availableUnits()
{
    ...
    unitlist.append(SSMN);
    unitlist.append(mSSMN);
    unitlist.append(uSSMN);
    return unitlist;
}
...
QString BitcoinUnits::id(int unit)
{
    switch (unit) {
    case SSMN:
        return QString("spectresecurity");
    case mSSMN:
        return QString("mspectresecurity");
    case uSSMN:
        return QString::fromUtf8("uspectresecurity");
    default:
        return QString("???");
    }
}

QString BitcoinUnits::name(int unit, bool isZssmn)
{
...
QString BitcoinUnits::floorWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSSMN)
{
    QSettings settings;
    ...
    return result + QString(" ") + name(unit, isZSSMN);
}

QString BitcoinUnits::floorHtmlWithUnit(int unit, const CAmount& amount, bool plussign, SeparatorStyle separators, bool cleanRemainderZeros, bool isZSSMN)
{
    QString str(floorWithUnit(unit, amount, plussign, separators, cleanRemainderZeros, isZSSMN));
    str.replace(QChar(THIN_SP_CP), QString(COMMA_HTML));
    return QString("<span style='white-space: nowrap;'>%1</span>").arg(str);
}
