...
void AskPassphraseDialog::accept()
{
    ...
    case Mode::Encrypt: {
        ...
        if (ret) {
            ...
            SPECTRESECURITYGUI* window = static_cast<SPECTRESECURITYGUI*>(parentWidget());
...
{
    SPECTRESECURITYGUI* gui = static_cast<SPECTRESECURITYGUI*>(parentWidget());
...
{
    hide();
    static_cast<SPECTRESECURITYGUI*>(parentWidget())->showHide(true);
    openStandardDialog(
            tr("Wallet encrypted"),
            "<qt>" +
