...
/** Utility functions used by the SPECTRESECURITY Qt UI.
 */
namespace GUIUtil
{
...
// Render SPECTRESECURITY addresses in monospace font
...
// Format an amount
QString formatBalance(CAmount amount, int nDisplayUnit = 0, bool isZssmn = false);
QString formatBalanceWithoutHtml(CAmount amount, int nDisplayUnit = 0, bool isZssmn = false);
...
// Parse "spectresecurity:" URI into recipient object, return true on successful parsing
