...
BOOST_AUTO_TEST_CASE(test_Capitalize)
{
    ...
    BOOST_CHECK_EQUAL(Capitalize("spectresecurity"), "Spectresecurity");
...
BOOST_AUTO_TEST_CASE(test_validateURL)
{
    ...
    BOOST_CHECK(validateURL("https://foo.bar/"));
    BOOST_CHECK(validateURL("http://spectresecurity.foo.bar"));
    BOOST_CHECK(validateURL("https://foo.bar/spectresecurity"));
    BOOST_CHECK(validateURL("https://foo.bar/spectresecurity/more/"));
    BOOST_CHECK(validateURL("https://142.2.3.1"));
    BOOST_CHECK(validateURL("https://foo_bar.spectresecurity.com"));
