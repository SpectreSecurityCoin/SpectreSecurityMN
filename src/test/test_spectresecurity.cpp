...
#define BOOST_TEST_MODULE Spectresecurity Test Suite
...
BasicTestingSetup::BasicTestingSetup(const std::string& chainName)
    : m_path_root{fs::temp_directory_path() / "test_spectresecurity" / std::to_string(g_insecure_rand_ctx_temp_path.rand32())}
{
    ECC_Start();
    BLSInit();
    SetupEnvironment();
