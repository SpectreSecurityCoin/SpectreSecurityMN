 ...
 *  A CTxDestination is the internal data type encoded in a SPECTRESECURITY address
 */
...
/**
 * Generate a SPECTRESECURITY scriptPubKey for the given CTxDestination. Returns a P2PKH
