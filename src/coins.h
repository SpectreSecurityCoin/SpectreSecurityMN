...
public:
    ...
    /**
     * Amount of spectresecurity coming in to a transaction
...
// SPECTRESECURITY: When check is false, this assumes that overwrites are never possible due to BIP34 always in effect
